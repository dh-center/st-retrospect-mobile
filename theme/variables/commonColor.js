...
export default {
  ...
  toolbarBtnTextColor: this.brandDark,
  iosStatusbar: 'dark-content',
  toolbarDefaultBorder: this.brandDark,
  get statusBarColor() {
  ...
  // Tab
  tabDefaultBg: this.brandLight,
  topTabBarTextColor: this.brandDark,
  topTabBarActiveTextColor: this.brandPrimary,
